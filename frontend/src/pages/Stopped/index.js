    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.box}>
          ...
          <p>Unfortunately, this experiment ended prematurely because a player in your group left the experiment or has been idle for several minutes. As a result, you are the other players cannot continue the experiment. Although it is not a technical issue, we want to sincerely apologize that you are not able to complete this experiment.</p>
