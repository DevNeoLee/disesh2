    ...
    <div className={styles.container}>
      <div className={styles.breadcrumbContainer}><Bar now={now}/></div>
      {
        ...
        <div className={styles.content}>
          <div className={styles.box}>
            ...
            <div className={styles.paragraph}>
              <p>We regret to inform you that <span>one or more members in your group have dropped out of the exercises unexpectedly.</span> We understand that this may be disappointing, but unfortunately, without the full participation of all group members, <span>we are unable to continue the exercises for the rest of your group.</span></p>
            </div>
            <div className={styles.paragraph}>
              <p>We sincerely apologize for any inconvenience this may cause. We value your time and commitment to the exercises. <span>Within 48 hours, you will receive the participation fee of $1 plus other earnings you are entitled to.</span></p>          
            </div>
            <div className={styles.paragraph}>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.paragraph}>
            <p>Unfortunately, due to your dropout, the other players in your group are also <span>unable to continue the exercise</span>, resulting in its <span>termination for all participants</span>.
            </p>
          </div>
          <div className={styles.paragraph}>
            <p>Thank you for your understanding and cooperation.</p>        
