    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.box}>
          <h1>Thanks for your participation in the exercises.</h1>
          <div className={styles.paragraph}>
            {/* <p>Thank you. The experiment is over now!{Math.round((totalTokens * 0.1 + 2) * 100) / 100}</p> */}
            <p><span style={{ fontWeight: "bold", fontSize: "1.3rem"}}>Your overall earnings <span className={styles.spanEmphasize}><span className={styles.unit}> $ </span> {Math.round((totalTokens * 0.1 + 1 + completionFee) * 100) / 100}</span></span> are summarized in the table below.<br/> To receive your payment, please <span style={{ fontWeight: "bold", fontSize: "1.3rem"}}> save and use the M-Turk code </span>shown in the bottom of the page.</p>
          </div>
        ...
        <div className={styles.table} style={{ border: "2px solid black"}}>
          <Table striped bordered hover>
              <tbody>
                  ...
                  <td><span className={styles.spanEmphasize}><span className={styles.unit}> $ </span> {Math.round(totalTokens * 0.1  * 100) / 100}</span>(<span className={styles.spanEmphasize}>{totalTokens} <span style={{ fontSize: "0.9rem", color: "#0065ff"}}>tokens</span></span>)</td>
                  </tr>
                  ...
                  <tr>
                  <td><p>Participation Fee (completing quizzes)</p></td>
                  <td><span className={styles.spanEmphasize}><span className={styles.unit}> $ </span> 1 </span></td>
                  </tr>
                  ...
                  <td><span className={styles.spanEmphasize} style={{ fontWeight: "bold"}}><span className={styles.unit}> $ </span> {Math.round((totalTokens * 0.1 + 1 + completionFee) * 100) / 100}</span></td>
                  </tr>
              </tbody>
          </Table>
        </div>
