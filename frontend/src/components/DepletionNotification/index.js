  ...
  return (
    <Card style={{ letterSpacing: "1px", width: '55rem', height: "26rem", position: 'fixed', top: '40%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: "2000"}}>
      ...
      <Card.Body style={{ fontSize: "1.2rem", width: "100%", height: "100%"}}>
        ...
        <div style={{ padding: "0.7rem 1rem", fontSize: "1.2rem", width: "100%", textAlign: "center", height: "15%"}}><span style={{ fontSize: "1.5rem", color: "#0065ff", margin: "1rem 1rem"}}>{count}</span>{count > 1 ? "seconds" : "second"}</div>
      </Card.Body>
    </Card>
  );
}
