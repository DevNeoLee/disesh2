  ...
  return (
    <Card style={{ letterSpacing: "1px", width: '55rem', height: "23rem", position: 'fixed', top: '48%', left: '50%', transform: 'translate(-48%, -50%)', zIndex: "2000", paddingTop: "38px"}}>
      ...
      <Card.Body style={{ fontSize: "1.2rem", width: "100%", height: "100%"}}>
        ...
        <div style={{ padding: "2rem 1rem", fontSize: "1.2rem", width: "100%", textAlign: "center", letterSpacing: "2px"}}> Starts in <span style={{ fontSize: "1.7rem", color: "#0065ff", margin: "1rem 1rem"}}>{practiceEndDuration}</span>{practiceEndDuration > 1 ? "seconds" : "second"}</div>
      </Card.Body>
    </Card>
  );
}
